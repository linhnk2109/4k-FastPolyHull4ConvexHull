## Sequential 4k-FastPolyHull implementation adapted for use as a library.
## The algorithmic logic is unchanged. Two integration-only changes were made:
##  1. The self-running demo at the end of the original source was removed so
##     that including this file does not execute a benchmark.
##  2. The optional LoopVectorization.@avx annotation in find_P was replaced
##     by Base.@inbounds. This removes an external dependency without changing
